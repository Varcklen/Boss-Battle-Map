scope RunestoneChad initializer init

	globals
		private constant integer VALUE_TO_ADD = -90
		private constant integer STAT_TYPE = STAT_DAMAGE_DEALT_PHY
		private constant integer ABILITY_USED = 'A1G1'
		
		private constant integer ITEM_ID = 'I0DU'
	endglobals
