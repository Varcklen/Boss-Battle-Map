...
function Magic_AbsorberCast takes nothing returns nothing
    ...
    local integer pl = LoadInteger( udg_hash, id, StringHash( "pwsipl" ) )
...
function Trig_Magic_Absorber_Actions takes nothing returns nothing
    ...
    call SaveInteger( udg_hash, id, StringHash( "pwsipl" ), GetPlayerId( GetOwningPlayer( GetManipulatingUnit() ) ) )
