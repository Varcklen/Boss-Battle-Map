...
function Trig_PokeballG_Actions takes nothing returns nothing
    ...
    //if (udg_Multiboard_Sets[i] == "" or udg_Multiboard_Sets[i + 1] == "" or udg_Multiboard_Sets[i + 2] == "") and not(udg_Multiboard_Sets[i] == "Мехатрон" or udg_Multiboard_Sets[i + 1] == "Мехатрон" or udg_Multiboard_Sets[i + 2] == "Мехатрон") then
        set udg_Caster = u
