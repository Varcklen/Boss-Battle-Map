scope Rivalry initializer init

    globals
        private constant integer EFFECT = 'A1D2'
        private constant integer BUFF = 'B0AB'
        private constant integer ID_ARMOR_BONUS = 'A1D3'
        
        private constant integer AREA = 300
        private constant real MAGIC_RESISTANCE_BONUS = 0.1
    ...
    private function Mode_Awake takes nothing returns nothing
        ...
        loop
            ...
            if udg_hero[i] != null then
                call InvokeTimerWithUnit(udg_hero[i], "mdb32", 2, true, function RivalryCheck )
            endif
            set i = i + 1
        endloop
    endfunction
