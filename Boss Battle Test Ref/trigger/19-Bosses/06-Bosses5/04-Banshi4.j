function Trig_Banshi4_Conditions takes nothing returns boolean
    return GetUnitTypeId(udg_DamageEventTarget) == 'n03M' and GetUnitLifePercent(udg_DamageEventTarget) <= 25. and IsUnitVisible( udg_DamageEventTarget, Player(PLAYER_NEUTRAL_AGGRESSIVE))
endfunction

function Trig_Banshi4_Actions takes nothing returns nothing
...
//===========================================================================
function InitTrig_Banshi4 takes nothing returns nothing
    set gg_trg_Banshi4 = CreateTrigger(  )
    call DisableTrigger( gg_trg_Banshi4 )
    call TriggerRegisterVariableEvent( gg_trg_Banshi4, "udg_AfterDamageEvent", EQUAL, 1.00 )
    call TriggerAddCondition( gg_trg_Banshi4, Condition( function Trig_Banshi4_Conditions ) )
    call TriggerAddAction( gg_trg_Banshi4, function Trig_Banshi4_Actions )
endfunction
